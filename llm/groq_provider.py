...
from data_mining.core.security import sanitize_secrets, wrap_untrusted_content
        ...
        if resp:
            try:
                ...
                return ComparisonResult(
                    ...
                    equivalence_reasoning=data.get("equivalence_reasoning", "LLM comparison evaluated"),
        ...
        if resp:
            try:
                ...
                return ModelInfo(
                    ...
                    model_name=data.get("model_name", "AI Model"),
                    ...
                    free_status=FreeStatus(data.get("free_status", "unknown")),
        ...
        if resp:
            try:
                ...
                return FreeServiceInfo(
                    service_name=data.get("service_name", "AI Service"),
                    domain=data.get("domain", source_url.split("/")[2]),
                    models=data.get("models", ["AI Model"]),
                    api_available=bool(data.get("api_available", False)),
                    free_status=FreeStatus(data.get("free_status", "unknown")),
                    limits=data.get("limits", "Free tier quotas"),
                    ...
                    region_restrictions=data.get("region_restrictions", "None"),
